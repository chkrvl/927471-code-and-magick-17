...
var wizards = [
  {
    name: getRandomElement(wizardData.firstNameList) + ' ' + getRandomElement(wizardData.secondNameList),
    coatColor: getRandomElement(wizardData.coatColorList),
    eyesColor: getRandomElement(wizardData.eyesColorList)
  },
  {
    name: getRandomElement(wizardData.firstNameList) + ' ' + getRandomElement(wizardData.secondNameList),
    coatColor: getRandomElement(wizardData.coatColorList),
